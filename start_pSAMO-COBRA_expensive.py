...
if __name__ == '__main__':  
    ...
    problem = BNH()
    problem.cheapConstr = [False]*len(problem.cheapConstr) 
...
# xtest = lhs(len(problem.lower), samples=10000, criterion="center", iterations=5)
# xtest = transformLHS(xtest, problem.lower, problem.upper)
# cons = []
# objs = []
# for x in xtest:
...
#     objs.append(obj)
#     cons.append(con)
# trueCons = np.array(cons)
# trueObjs = np.array(objs)
